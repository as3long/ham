...
var sessions = {};
var hamSessionKey = 'ham_session_id';
...
var serialize = function(name, value, option) {
    ...
    if (option.expires) {
        pairs.push('Expires=' + option.expires);
    }
...
module.exports = function(req, res) {
    ...
    var id = req.cookies[hamSessionKey];
    ...
    res.writeHead = function() {
        delete req.cookies[hamSessionKey];
        var sessionStr = serialize(hamSessionKey, req.session.id);
